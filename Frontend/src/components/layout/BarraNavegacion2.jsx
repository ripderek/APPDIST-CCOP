...
export function BarraNavegacion2({ routes, brandImg, brandName }) {
  ...
  return (
    <aside
      ...
      } fixed inset-0 z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 transition-transform duration-300 xl:translate-x-0   rounded-2xl shadow-2xl  `}
    >
      <div className={`relative `}>
        <Card
          className={`w-auto shadow-none mb-0 ${
            sidenavType === "dark" ? "bg-blue-gray-700 " : "bg-white"
          }`}
        >
          <CardHeader
            floated={false}
            className={`h-auto w-44 mx-auto text-center shadow-none bg-transparent`}
          >
            {/* 
            ...
            */}
            ...
            <Typography
              ...
              className={`mb-2 ${
                sidenavType === "dark" ? "text-white " : "text-light-blue-900 "
              }`}
            >
              Senias App
            </Typography>
